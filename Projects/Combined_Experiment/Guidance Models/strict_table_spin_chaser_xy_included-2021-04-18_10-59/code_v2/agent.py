...
class Agent:
    ...
    def create_summary_functions(self):
        ...
        self.regular_episode_summary          = tf.compat.v1.summary.merge([timestep_number_summary, episode_reward_summary])
        ...
        if self.n_agent == 1:
            ...
            self.test_time_episode_summary    = tf.compat.v1.summary.merge([test_time_episode_reward_summary, test_time_timestep_number_summary])
