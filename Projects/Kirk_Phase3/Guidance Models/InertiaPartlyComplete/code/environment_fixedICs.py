...
DATA_FILE_TIME = '42-22' # a unique identifier of the data file we wish to use for initial conditions. Usually two time entries will do
...
class Environment:
    ...
    def __init__(self):
        ...
        Pi_time, deep_guidance_Ax, deep_guidance_Ay, deep_guidance_alpha_base, \
                                 ...
                                 shoulder_omega, elbow_omega, wrist_omega, docked = data[1,:]
