...
class Agent:
    ...
    def create_summary_functions(self):
        ...
        if self.n_agent == 1:
            ...
            self.test_time_episode_summary_docked         = tf.compat.v1.summary.merge([test_time_episode_reward_summary, test_time_timestep_number_summary, combined_angular_momentum_if_captured_summary, combined_angular_rate_if_captured_summary])
            self.test_time_episode_summary_not_docked     = tf.compat.v1.summary.merge([test_time_episode_reward_summary, test_time_timestep_number_summary])
